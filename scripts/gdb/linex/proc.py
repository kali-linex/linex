...
import gdb
from linex import constants
from linex import utils
from linex import tasks
from linex import lists
from linex import vfs
from struct import *


class LxCmdLine(gdb.Command):
    """ Report the Linex Commandline used in the current kernel.
...
class LxVersion(gdb.Command):
    """ Report the Linex Version of the current kernel.
    ...
    def invoke(self, arg, from_tty):
        # linex_banner should contain a newline
        gdb.write(gdb.parse_and_eval("(char *)linex_banner").string())
