...
class LxTaskByPidFunc(gdb.Function):
    """Find Linex task by PID and return the task_struct variable.
...
class LxThreadInfoFunc (gdb.Function):
    """Calculate Linex thread_info from task variable.
...
class LxThreadInfoByPidFunc (gdb.Function):
    """Calculate Linex thread_info from task variable found by pid
