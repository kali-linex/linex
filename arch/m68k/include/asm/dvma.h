...
/* Linex DMA information structure, filled during probe. */
struct Linex_SBus_DMA {
	struct Linex_SBus_DMA *next;
	struct linex_sbus_device *SBus_dev;
...
extern struct Linex_SBus_DMA *dma_chain;
