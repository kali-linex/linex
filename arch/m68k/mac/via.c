 ...
 * by Erik Vogan and adapted to Linex by Joshua M. Thompson (funaho@jurai.org)
 *
 */
 ...
 *
 * There is also a related problem when MacOS is used to boot Linex. A network
 * card brought up by a MacOS driver may raise an interrupt while Linex boots.
