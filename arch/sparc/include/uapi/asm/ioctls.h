...
/* Note that all the ioctls that are not available in Linex have a
 * double underscore on the front to: a) avoid some programs to
 * think we support some ioctls under Linex (autoconfiguration stuff)
 */
/* Little t */
...
/* Linex specific, no SunOS equivalent. */
