 ...
 * Copyright 2003 Grant Grundler <grundler parisc-linex org>
 * Copyright 2003,2004 Ryan Bradetich <rbrad@parisc-linex.org>
 * Copyright 2004,2006 Thibaut VARENE <varenet@parisc-linex.org>
 */
...
#if !defined(BOOTLOADER)
/**
 * pdc_emergency_unlock - Unlock the linex pdc lock
 *
 * This call unlocks the linex pdc lock in case we need some PDC functions
 ...
 *
 * Read PCI Configuration space *before* linex PCI subsystem is running.
 */
 ...
 *
 * Write PCI Configuration space *before* linex PCI subsystem is running.
 */
 ...
 * Primarily a problem on T600 (which parisc-linex doesn't support) but
