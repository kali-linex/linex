...
/* Allocate the controller structure and setup the linex irq descs
 ...
 * that is senses[0] correspond to linex irq "irq_offset".
 */
 ...
 * IPI number is then the offset'ed (linex irq number mapped to the IPI)
 */
