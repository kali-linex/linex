 ...
 * phys_addr: an address in what Linex thinks is the physical address space
...
/**
 * ps3_mm_phys_to_lpar - translate a linex physical address to lpar address
 * @phys_addr: linex physical address
 */
