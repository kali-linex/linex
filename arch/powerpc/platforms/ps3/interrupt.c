 ...
 * implementation equates HV plug value to Linex virq value, constrains each
...
/**
 * ps3_irq_chip - Represents the ps3_bmp as a Linex struct irq_chip.
 */
