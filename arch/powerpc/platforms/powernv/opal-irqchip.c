 ...
 * that Linex needs to do something about. These basically look like
 * interrupts to Linex so we implement an irqchip to handle them.
 *
 ...
 *
 * This routine can be used to find the linex virq number which can
