 ...
 * we need to finesse (read: hack) the Linex BAR allocator so that it will
 ...
 *
 * 2. Later, when Linex actually assigns resources it tries to make the resource
 ...
 * the Linex BAR allocation will place any BAR marked as non-prefetchable into
