 ...
 * necessary. The Linex io routines will endian swap the data.
 */
 ...
 *
 * @dev:    The Linex PCI device structure for the device to map
 * @slot:   The slot number for this device on __BUS 0__. Linex
...
int pcibios_plat_dev_init(struct pci_dev *dev)
{
	 ...
	 * Linex bus scan doesn't seem to set it. Octeon really has
