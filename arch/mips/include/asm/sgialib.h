 ...
 * for more details.
 *
 * SGI ARCS firmware interface library for the Linex kernel.
 *
 ...
 */
extern struct linex_mdesc *prom_getmdesc(struct linex_mdesc *curr);
#define PROM_NULL_MDESC	  ((struct linex_mdesc *) 0)
