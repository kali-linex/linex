...
#ifndef _UAPI__LINEX_OPENVSWITCH_H
#define _UAPI__LINEX_OPENVSWITCH_H 1
...
struct ovs_vport_stats {
	...
	__u64   rx_dropped;		/* no space in linex buffers    */
	__u64   tx_dropped;		/* no space available in linex  */
};
