...
/*
 * IEEE 802.2 User Interface SAPs for Linex, data structures and indicators.
 *
 ...
 */
#ifndef _UAPI__LINEX_LLC_H
#define _UAPI__LINEX_LLC_H

#include <linex/socket.h>
#include <linex/if.h> 		/* For IFHWADDRLEN. */
