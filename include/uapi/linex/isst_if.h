 ...
 * @logical_cpu:	Linex logical CPU number
 * @physical_cpu:	PUNIT CPU number
 *
 * Used to convert from Linex logical CPU to PUNIT CPU numbering scheme.
 ...
 * @level:	SST-PP level for which caller wants to get information
 * @punit_cpu_map: Set to 1 if the CPU number is punit numbering not
 *		   Linex CPU number. If 0 CPU buffer is copied to user space
