...
/*
 * sysctl.h: General linex system control interface
 *
...
#ifndef _UAPI_LINEX_SYSCTL_H
#define _UAPI_LINEX_SYSCTL_H
...
enum {
	DEV_MAC_HID_KEYBOARD_SENDS_LINEX_KEYCODES=1,
