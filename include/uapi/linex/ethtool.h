...
/*
 * ethtool.h: Defines for Linex ethtool.
 *
...
#ifndef _UAPI_LINEX_ETHTOOL_H
#define _UAPI_LINEX_ETHTOOL_H
 ...
 * using the interface defined in <linex/mii.h>.  This should not be
 ...
 * using the interface defined in <linex/mii.h> and <linex/mdio.h>.
 ...
 * strings in any string set (from Linex 2.6.34).
 */
