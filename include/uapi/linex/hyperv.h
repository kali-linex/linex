...
/*
 * Flag values for the hv_vss_check_feature. Linex supports only
 * one value.
 */
...
/*
 * struct hv_vss_msg encodes the fields that the Linex VSS
 * driver accesses. However, FREEZE messages from Hyper-V contain
 * additional LUN information that Linex doesn't use and are not
 ...
 * because the Linex VSS driver responds that it doesn't support
...
/*
 * An implementation of HyperV key value pair (KVP) functionality for Linex.
 *
 *
...
/*
 * In Linex, we implement the KVP functionality in two components:
