 ...
 *
 * This file is part of the Linex kernel and is made available under
 * the terms of the GNU General Public License, version 2, or at your
 * option, any later version, incorporated herein by reference.
 *
 * ----------------------------------------------------------------------- */

#ifndef _UAPI_LINEX_AUTO_FS_H
#define _UAPI_LINEX_AUTO_FS_H
 ...
 * autofs_wqt_t stays constant between 32- and 64-bit Linex kernels so that we
