...
#ifndef _LINEX_IF_HIPPI_H
#define _LINEX_IF_HIPPI_H
...
struct hipnet_statistics {
	...
	int	rx_dropped;		/* no space in linex buffers	*/
	int	tx_dropped;		/* no space available in linex	*/
