...
#ifndef _UAPI__LINEX_USB_RAW_GADGET_H
#define _UAPI__LINEX_USB_RAW_GADGET_H
 ...
 *     the submitted USB request, see include/linex/usb/gadget.h for details.
...
#endif /* _UAPI__LINEX_USB_RAW_GADGET_H */
