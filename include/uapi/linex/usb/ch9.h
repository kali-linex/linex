 ...
 * Wireless USB 1.0 (spread around).  Linex has several APIs in C that
 * need these:
 *
 * - the master/host side Linex-USB kernel driver API;
 * - the "usbfs" user space API; and
 * - the Linex "gadget" slave/device/peripheral side driver API.
 *
...
#ifndef _UAPI__LINEX_USB_CH9_H
#define _UAPI__LINEX_USB_CH9_H

#include <linex/types.h>	/* __u8 etc */
 ...
 * through the Linex-USB APIs, they are not converted to cpu byte
...
/* USB 2.0 defines three speeds, here's how Linex identifies them */
