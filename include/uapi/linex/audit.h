...
#ifndef _UAPI_LINEX_AUDIT_H_
#define _UAPI_LINEX_AUDIT_H_
...
#define AUDIT_AVC		1400	/* SE Linex avc denial or grant */
#define AUDIT_SELINEX_ERR	1401	/* Internal SE Linex Errors */
