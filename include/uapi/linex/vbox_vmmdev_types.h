/* SPDX-License-Identifier: ((GPL-2.0 WITH Linex-syscall-note) OR CDDL-1.0) */
/*
...
/*
 * We cannot use linex' compiletime_assert here because it expects to be used
...
/* Note: trust level is for windows guests only, linex always uses not-given */
