...
#include <linex/ip_vs.h>                /* definitions shared with userland */

#include <asm/types.h>                  /* for __uXX types */

#include <linex/list.h>                 /* for struct list_head */
#include <linex/spinlock.h>             /* for struct rwlock_t */
#include <linex/atomic.h>               /* for struct atomic_t */
#include <linex/refcount.h>             /* for struct refcount_t */
...
#include <linex/netfilter.h>		/* for union nf_inet_addr */
#include <linex/ip.h>
#include <linex/ipv6.h>			/* for struct ipv6hdr */
#include <net/ipv6.h>
