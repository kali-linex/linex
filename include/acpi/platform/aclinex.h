...
/******************************************************************************
 *
 * Name: aclinex.h - OS specific defines, etc. for Linex
 *
 * Copyright (C) 2000 - 2023, Intel Corp.
 *
 *****************************************************************************/

#ifndef __ACLINEX_H__
#define __ACLINEX_H__

#ifdef __KERNEL__

/* ACPICA external files should not include ACPICA headers directly. */

#if !defined(BUILDING_ACPICA) && !defined(_LINEX_ACPI_H)
#error "Please don't include <acpi/acpi.h> directly, include <linex/acpi.h> instead."
#endif
...
/* Use native linex version of acpi_os_allocate_zeroed */
...
/*
 * Linex wants to use designated initializers for function pointer structs.
 */
