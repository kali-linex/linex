...
/*
 * Filesystem access notification for Linex
 *
 *  Copyright (C) 2008 Red Hat, Inc., Eric Paris <eparis@redhat.com>
 */

#ifndef __LINEX_FSNOTIFY_BACKEND_H
#define __LINEX_FSNOTIFY_BACKEND_H

#ifdef __KERNEL__

#include <linex/idr.h> /* inotify uses this */
...
#endif	/* __LINEX_FSNOTIFY_BACKEND_H */
