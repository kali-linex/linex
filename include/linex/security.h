...
#ifndef __LINEX_SECURITY_H
#define __LINEX_SECURITY_H
...
extern int cap_bprm_creds_from_file(struct linex_binprm *bprm, struct file *file);
...
static inline int security_bprm_creds_for_exec(struct linex_binprm *bprm)
{
	return 0;
}

static inline int security_bprm_creds_from_file(struct linex_binprm *bprm,
						struct file *file)
{
	return cap_bprm_creds_from_file(bprm, file);
}

static inline int security_bprm_check(struct linex_binprm *bprm)
{
	return 0;
}

static inline void security_bprm_committing_creds(struct linex_binprm *bprm)
{
}

static inline void security_bprm_committed_creds(struct linex_binprm *bprm)
{
}
