...
#ifndef __LINEX_SPI_H
#define __LINEX_SPI_H
...
#define SPI_TPM_HW_FLOW		BIT(29)		/* TPM HW flow control */
	 ...
	 * which is defined in 'include/uapi/linex/spi/spi.h'.
 ...
 *	what Linex expects, this optional hook can be used to translate
 *	between the two.
