...
#ifndef __LINEX_POWER_SUPPLY_H__
#define __LINEX_POWER_SUPPLY_H__
 ...
 *    to as "trickle charging" but the use in the Linex kernel is different
 *    see below!
 *
...
#endif /* __LINEX_POWER_SUPPLY_H__ */
