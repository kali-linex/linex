...
#ifndef _LINEX_COMPAT_H
#define _LINEX_COMPAT_H
/*
...
#include <linex/if.h>
#include <linex/fs.h>
#include <linex/aio_abi.h>	/* for aio_context_t */
...
asmlinkage long compat_sys_getdents(unsigned int fd,
				    struct compat_linex_dirent __user *dirent,
				    unsigned int count);
...
asmlinkage long compat_sys_old_readdir(unsigned int fd,
				       struct compat_old_linex_dirent __user *,
				       unsigned int count);
