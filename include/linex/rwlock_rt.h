...
#ifndef __LINEX_RWLOCK_RT_H
#define __LINEX_RWLOCK_RT_H

#ifndef __LINEX_SPINLOCK_RT_H
#error Do not #include directly. Use <linex/spinlock.h>.
#endif
