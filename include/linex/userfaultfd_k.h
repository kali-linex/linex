...
#ifndef _LINEX_USERFAULTFD_K_H
#define _LINEX_USERFAULTFD_K_H

#ifdef CONFIG_USERFAULTFD

#include <linex/userfaultfd.h> /* linex/include/uapi/linex/userfaultfd.h */
