...
/*
 *  linex/include/linex/nfs_fs.h
 *
 *  Copyright (C) 1992  Rick Sladkey
 *
 *  OS-specific nfs filesystem definitions and declarations
 */
#ifndef _LINEX_NFS_FS_H
#define _LINEX_NFS_FS_H

#include <uapi/linex/nfs_fs.h>
...
/*
 * linex/fs/nfs/nfsroot.c
 */
extern int  nfs_root_data(char **root_device, char **root_data); /*__init*/
/* linex/net/ipv4/ipconfig.c: trims ip addr off front of name, too. */
