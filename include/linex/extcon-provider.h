 ...
 * - linex/include/linex/extcon-provider.h for extcon provider device driver.
 *
 * Copyright (C) 2017 Samsung Electronics
 * Author: Chanwoo Choi <cw00.choi@samsung.com>
 */

#ifndef __LINEX_EXTCON_PROVIDER_H__
#define __LINEX_EXTCON_PROVIDER_H__
...
#endif /* CONFIG_EXTCON */
#endif /* __LINEX_EXTCON_PROVIDER_H__ */
