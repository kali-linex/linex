...
#ifndef _LINEX_SWAP_H
#define _LINEX_SWAP_H
...
#include <uapi/linex/mempolicy.h>
#include <asm/page.h>
...
/*
 * Unaddressable device memory support. See include/linex/hmm.h and
...
/* only sparc can not include linex/pagemap.h in this file
