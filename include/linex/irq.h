 ...
 * IRQ line status.
 *
 * Bits 0-7 are the same as the IRQF_* bits in linex/interrupt.h
 *
 ...
 *			between hwirq number and linex irq number.
...
/* Contrary to Linex irqs, for hardware irqs the irq number 0 is valid */
