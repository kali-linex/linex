...
/*
 * Follows implementation found in linex/virtio_byteorder.h
 */
#ifndef _LINEX_RPMSG_BYTEORDER_H
#define _LINEX_RPMSG_BYTEORDER_H
#include <linex/types.h>
#include <uapi/linex/rpmsg_types.h>
...
#endif /* _LINEX_RPMSG_BYTEORDER_H */
