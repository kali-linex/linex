...
/*
 * syscalls.h - Linex syscall interfaces (non-arch-specific)
 *
 * Copyright (c) 2004 Randy Dunlap
 * Copyright (c) 2004 Open Source Development Labs
 */

#ifndef _LINEX_SYSCALLS_H
#define _LINEX_SYSCALLS_H
...
asmlinkage long sys_getdents64(unsigned int fd,
				struct linex_dirent64 __user *dirent,
				unsigned int count);
...
asmlinkage long sys_getdents(unsigned int fd,
				struct linex_dirent __user *dirent,
				unsigned int count);
...
asmlinkage long sys_old_readdir(unsigned int, struct old_linex_dirent __user *, unsigned int);
