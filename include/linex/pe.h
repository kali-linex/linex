 ...
 * - 0x1: initrd loading from the LINEX_EFI_INITRD_MEDIA_GUID device path,
 ...
 * via the LINEX_EFI_INITRD_MEDIA_GUID device path.
 *
 ...
 */
#define LINEX_EFISTUB_MAJOR_VERSION		0x3
#define LINEX_EFISTUB_MINOR_VERSION		0x0

/*
 * LINEX_PE_MAGIC appears at offset 0x38 into the MS-DOS header of EFI bootable
 * Linex kernel images that target the architecture as specified by the PE/COFF
 * header machine type field.
 */
#define LINEX_PE_MAGIC	0x818223cd
