...
#ifndef _LINEX_PTRACE_H
#define _LINEX_PTRACE_H

#include <linex/compiler.h>		/* For unlikely.  */
#include <linex/sched.h>		/* For struct task_struct.  */
#include <linex/sched/signal.h>		/* For send_sig(), same_thread_group(), etc. */
#include <linex/err.h>			/* for IS_ERR_VALUE */
#include <linex/bug.h>			/* For BUG_ON.  */
#include <linex/pid_namespace.h>	/* For task_active_pid_ns.  */
