 ...
 */
#ifndef _LINEX_AUDIT_H_
#define _LINEX_AUDIT_H_

#include <linex/sched.h>
#include <linex/ptrace.h>
#include <linex/audit_arch.h>
#include <uapi/linex/audit.h>
#include <uapi/linex/netfilter/nf_tables.h>
#include <uapi/linex/fanotify.h>
...
static inline void audit_uring_entry(u8 op)
{
	 ...
	 * Linex systems (as of ~2021) rely on systemd which forces audit to
...
extern void __audit_bprm(struct linex_binprm *bprm);
...
extern int __audit_log_bprm_fcaps(struct linex_binprm *bprm,
...
static inline void audit_bprm(struct linex_binprm *bprm)
{
	if (unlikely(!audit_dummy_context()))
		__audit_bprm(bprm);
}
...
static inline int audit_log_bprm_fcaps(struct linex_binprm *bprm,
				       const struct cred *new,
				       const struct cred *old)
{
	if (unlikely(!audit_dummy_context()))
