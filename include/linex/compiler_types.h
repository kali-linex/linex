...
#ifndef __LINEX_COMPILER_TYPES_H
#define __LINEX_COMPILER_TYPES_H
...
#ifdef __clang__
#include <linex/compiler-clang.h>
#elif defined(__GNUC__)
/* The above compilers also define __GNUC__, so order is important here. */
#include <linex/compiler-gcc.h>
#else
 ...
 * by linex/compiler-*.h, and can do so using asm/compiler.h. We include that
...
#endif /* __LINEX_COMPILER_TYPES_H */
