...
#ifndef _LINEX_SIGNAL_H
#define _LINEX_SIGNAL_H
...
/* We don't use <linex/bitops.h> for these because there is no need to
   be atomic.  */
...
/*
 * In POSIX a signal is sent either to a specific thread (Linex task)
 * or to the process as a whole (Linex thread group).  How the signal
