 ...
 */
#ifndef _LINEX_BPF_H
#define _LINEX_BPF_H 1

#include <uapi/linex/bpf.h>
#include <uapi/linex/filter.h>
...
{
	return (map->btf_value_type_id || map->btf_vmlinex_value_type_id) &&
