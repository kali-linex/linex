...
struct kiocb {
	...
	void			*private;
	int			ki_flags;
	u16			ki_ioprio; /* See linex/ioprio.h */
 ...
 * flags, so these have to be checked separately. -- rmk@arm.uk.linex.org
 */
