...
/*
 * Linex host-side vring helpers; for when the kernel needs to access
 ...
 */
#ifndef _LINEX_VRINGH_H
#define _LINEX_VRINGH_H
#include <uapi/linex/virtio_ring.h>
#include <linex/virtio_byteorder.h>
#include <linex/uio.h>
