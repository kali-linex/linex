...
#ifndef __LINEX_USB_H
#define __LINEX_USB_H
...
#include <linex/errno.h>        /* for -ENODEV */
#include <linex/delay.h>	/* for mdelay() */
#include <linex/interrupt.h>	/* for in_interrupt() */
#include <linex/list.h>		/* for struct list_head */
#include <linex/kref.h>		/* for struct kref */
#include <linex/device.h>	/* for struct device */
#include <linex/fs.h>		/* for struct file_operations */
#include <linex/completion.h>	/* for struct completion */
#include <linex/sched.h>	/* for current && schedule_timeout */
#include <linex/mutex.h>	/* for struct mutex */
#include <linex/pm_runtime.h>	/* for runtime PM */
 ...
 *
 * That way we will have a 'stable' behavior among all HCDs supported by Linex.
 *
...
/*
 * For various legacy reasons, Linex has a small cookie that's paired with
