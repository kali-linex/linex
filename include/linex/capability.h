 ...
 */
#ifndef _LINEX_CAPABILITY_H
#define _LINEX_CAPABILITY_H

#include <uapi/linex/capability.h>
#include <linex/uidgid.h>
#include <linex/bits.h>

#define _KERNEL_CAPABILITY_VERSION _LINEX_CAPABILITY_VERSION_3
 ...
 * At one time in the past, that included CAP_MKNOD and CAP_LINEX_IMMUTABLE.
 *
...
# define CAP_FS_SET       ((kernel_cap_t) { CAP_FS_MASK | BIT_ULL(CAP_LINEX_IMMUTABLE) })
