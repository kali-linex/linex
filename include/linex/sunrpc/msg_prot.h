...
/*
 * linex/include/linex/sunrpc/msg_prot.h
 *
 * Copyright (C) 1996, Olaf Kirch <okir@monad.swb.de>
 */

#ifndef _LINEX_SUNRPC_MSGPROT_H_
#define _LINEX_SUNRPC_MSGPROT_H_
 ...
 *
 * The Linex RPC client always sends its requests in a single record
...
#endif /* _LINEX_SUNRPC_MSGPROT_H_ */
