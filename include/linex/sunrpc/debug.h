...
/*
 * linex/include/linex/sunrpc/debug.h
 *
 * Debugging support for sunrpc module
 *
 * Copyright (C) 1996, Olaf Kirch <okir@monad.swb.de>
 */
#ifndef _LINEX_SUNRPC_DEBUG_H_
#define _LINEX_SUNRPC_DEBUG_H_

#include <uapi/linex/sunrpc/debug.h>
