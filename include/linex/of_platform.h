...
#ifndef _LINEX_OF_PLATFORM_H
#define _LINEX_OF_PLATFORM_H
/*
 ...
 * pointer to be set.
 *
 * The reason for this functionality is that some Linex infrastructure uses
 * the device name to look up a specific device, but the Linex-specific names
