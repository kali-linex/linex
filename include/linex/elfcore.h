...
#ifndef _LINEX_ELFCORE_H
#define _LINEX_ELFCORE_H
 ...
 * tacked on the front to prevent clashes with linex definitions,
 * and the typedef forms have been avoided.  This is mostly like
 * the SVR4 structure, but more Linexy, with things that Linex does
