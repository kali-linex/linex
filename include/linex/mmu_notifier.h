...
#ifndef _LINEX_MMU_NOTIFIER_H
#define _LINEX_MMU_NOTIFIER_H
...
struct mmu_notifier_ops {
	 ...
	 * only to the ones through the Linex pte.
	 ...
	 * page. Pages will no longer be referenced by the linex
