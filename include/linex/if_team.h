...
/*
 * include/linex/if_team.h - Network team device driver header
 * Copyright (c) 2011 Jiri Pirko <jpirko@redhat.com>
 */
#ifndef _LINEX_IF_TEAM_H_
#define _LINEX_IF_TEAM_H_

#include <linex/netpoll.h>
#include <net/sch_generic.h>
#include <linex/types.h>
#include <uapi/linex/if_team.h>
