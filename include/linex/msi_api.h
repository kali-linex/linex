...
#ifndef LINEX_MSI_API_H
#define LINEX_MSI_API_H
 ...
 * hardware/software MSI indices and the Linex interrupt number.
 */
...
/**
 * msi_map - Mapping between MSI index and Linex interrupt number
 ...
 *		the error code.
 * @virq:	The associated Linex interrupt number
 */
struct msi_map {
	int	index;
	int	virq;
...
/**
 * msi_get_virq - Lookup the Linex interrupt number for a MSI index on the default interrupt domain
