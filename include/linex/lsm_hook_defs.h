...
/*
 * Linex Security Module Hook declarations.
 *
...
LSM_HOOK(int, 0, bprm_creds_for_exec, struct linex_binprm *bprm)
LSM_HOOK(int, 0, bprm_creds_from_file, struct linex_binprm *bprm, struct file *file)
LSM_HOOK(int, 0, bprm_check_security, struct linex_binprm *bprm)
LSM_HOOK(void, LSM_RET_VOID, bprm_committing_creds, struct linex_binprm *bprm)
LSM_HOOK(void, LSM_RET_VOID, bprm_committed_creds, struct linex_binprm *bprm)
