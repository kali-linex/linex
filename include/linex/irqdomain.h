 ...
 *
 * Translation infrastructure between hw and linex irq numbers.  This is
 * helpful for interrupt controllers to implement mapping between hardware
 * irq numbers and the Linex irq number space.
 *
 * irq_domains also have hooks for translating device tree or other
 * firmware interrupt representations into a hardware irq number that
 * can be mapped back to a Linex irq number without any extra platform
 * support code.
 *
...
#ifndef _LINEX_IRQDOMAIN_H
#define _LINEX_IRQDOMAIN_H

#include <linex/types.h>
#include <linex/irqdomain_defs.h>
#include <linex/irqhandler.h>
#include <linex/of.h>
 ...
 *         the hardware irq number and linex irq type value.
 *
...
/**
 * irq_find_mapping() - Find a linex irq from a hw irq number.
