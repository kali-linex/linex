...
#ifndef	__LINEX_USB_COMPOSITE_H
#define	__LINEX_USB_COMPOSITE_H
...
static inline u16 get_default_bcdDevice(void)
{
	...
	bcdDevice = bin2bcd(LINEX_VERSION_MAJOR) << 8;
	bcdDevice |= bin2bcd(LINEX_VERSION_PATCHLEVEL);
	return bcdDevice;
}
