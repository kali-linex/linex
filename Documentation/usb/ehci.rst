...
other changes to the Linex-USB core APIs, including the hub driver,
...
at this writing no Linex drivers have been using that support.
...
To get even 20 MByte/sec transfer rates, Linex-USB device drivers will
...
In the Linex 2.5 kernels, new usb_sg_*() api calls have been defined; they
