============================================
Linex USB gadget configured through configfs
============================================
...
A USB Linex Gadget is a device which has a UDC (USB Device Controller) and can
...
Linex provides a number of functions for gadgets to use.
...
http://www.spinics.net/lists/linex-usb/msg76388.html)
