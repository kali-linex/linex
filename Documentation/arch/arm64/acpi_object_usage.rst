...
===== ================ ========================================================
Name   Section         Usage for ARMv8 Linex
===== ================ ========================================================
...
\_OS   5.7.3           This method will return "Linex" by default (this is
                       the value of the macro ACPI_OS_NAME on Linex).  The
...
as the emulated NMI.  In Linex, this should not be the case but one should
