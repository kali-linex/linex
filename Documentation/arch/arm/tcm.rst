==================================================
ARM TCM (Tightly-Coupled Memory) handling in Linex
==================================================
...
the MMU is turned off. To avoid confusion the current Linex
implementation will map the TCM 1 to 1 from physical to virtual
memory in the location specified by the kernel. Currently Linex
