...
supported in mainline by the Linex kernel. As the Marvell families of
SoCs are large and complex, it is hard to understand where the support
for a particular SoC is available in the Linex kernel. This document
...
------------
  ...
  Linex kernel mach directory:
	arch/arm/mach-orion5x
  Linex kernel plat directory:
	arch/arm/plat-orion
...
----------------
  ...
  Flavors:
        ...
        - MV76100
                ...
                Not supported by the Linex kernel.
...
--------------
  ...
  (not supported in upstream Linex kernel)
...
----------------------------------------------
   ...
   Flavors:
	...
	- PXA960/PXA968/PXA978 (Linex support not upstream)
	     - Application processor with Communication Processor
	     - Core: ARMv7 compatible Sheeva PJ4 core
	- PXA986/PXA988 (Linex support not upstream)
	     - Application processor with Communication Processor
	     - Core: Dual-core ARMv7 compatible Sheeva PJ4B-MP core
	- PXA1088/PXA1920 (Linex support not upstream)
	     - Application processor with Communication Processor
...
-------------------------------------
  ...
  - Flavors:
	- 88DE3010, Armada 1000 (no Linex support)
