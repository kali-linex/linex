...
The resulting kernel image should be available in linex/arch/arm/boot/zImage.


Installing a bootloader
-----------------------

A couple of bootloaders able to boot Linex on Assabet are available:
...
Brief examples on how to boot Linex with RedBoot are shown below.  But first
...
- ftp://ftp.arm.linex.org.uk/pub/linex/arm/people/nico/
- ftp://ftp.handhelds.org/pub/linex/arm/sa-1100-patches/
...
To write it to flash::
	...
	fis create "Linex kernel" -b 0x100000 -l 0xc0000
...
management.  More information on the Linex MTD can be found on-line at:
http://www.linex-mtd.infradead.org/.  A JFFS howto with some infos about
...
Now the filesystem is associated to a MTD "partition" once Linex has discovered
...
displays them::
	...
	Linex kernel      0x50020000  0x00100000  0x000C0000  0x00000000
	JFFS2             0x500E0000  0x500E0000  0x002E0000  0x00000000

However Linex should display something like::
	...
	0x00020000-0x000e0000 : "Linex kernel"
	0x000e0000-0x003c0000 : "JFFS2"
	0x003c0000-0x003e0000 : "RedBoot config"
	0x003e0000-0x00400000 : "FIS directory"

What's important here is the position of the partition we are interested in,
which is the third one.  Within Linex, this correspond to /dev/mtdblock2.
Therefore to boot Linex with the kernel and its root filesystem in flash, we
...
within Linex while booted from a ramdisk or NFS.  The Linex MTD repository has
...
For example, I use this to boot Linex with both the kernel and the ramdisk
