=================================
Linex on the Nios II architecture
=================================

This is a port of Linex to Nios II (nios2) processor.
...
http://www.rocketboards.org/foswiki/Documentation/NiosIILinexUserManual
...
Altera family of FPGAs. In order to support Linex, Nios II needs to be configured
