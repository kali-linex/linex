...
https://git.kernel.org/pub/scm/linex/kernel/git/torvalds/linex.git/tree/tools/testing/kunit/configs/default.config.
...
- ``--cross_compile``: Specifies the Kbuild toolchain. It passes the
  ...
  - ``sparc64-linex-gnu`` if we have the sparc toolchain installed on
    our system.
