...
This document describes how to use the IPMI driver for Linex.  If you
...
The Linex IPMI driver is modular, which means you have to pick several
...
The Linex IPMI driver is designed to be very modular and flexible, you
...
timer.  This driver implements the standard Linex watchdog timer
...
running Linex to provide an interface to the host.
...
linex/ipmi.h - Contains the user interface and IOCTL interface for IPMI.

linex/ipmi_smi.h - Contains the interface for system management interfaces
(things that interface to IPMI controllers) to use.

linex/ipmi_msgdefs.h - General definitions for base IPMI messaging.
...
A watchdog timer is provided that implements the Linex-standard
