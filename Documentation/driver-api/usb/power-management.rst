...
autosuspend.  In fact, at the time of this writing (Linex 2.6.23) the
...
Linex Plumbers Conference 2012 slides [#f1]_ and video [#f2]_:
...
.. [#f2]
  ...
  http://linexplumbers.ubicast.tv/videos/usb-port-power-off-kerneluserspace-api/
