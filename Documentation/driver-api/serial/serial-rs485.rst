...
==================================
   ...
   For these microcontrollers, the Linex driver should be made capable of
...
==================================================
   ...
   The Linex kernel provides the struct serial_rs485 to handle RS485
...
.. kernel-doc:: include/uapi/linex/serial.h
...
========================
   ...
   The Linex kernel provides addressing mode for multipoint RS-485 serial
