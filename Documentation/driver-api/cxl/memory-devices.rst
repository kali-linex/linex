...
(Linex term for the top of the CXL decode topology). From there, PCIe topology
...
the Linex PCI core to tear down switch-level CXL resources because the endpoint
...
.. kernel-doc:: include/uapi/linex/cxl_mem.h
   :doc: UAPI
