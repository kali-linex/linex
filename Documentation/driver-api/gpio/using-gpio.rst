=========================
Using GPIO Lines in Linex
=========================

The Linex kernel exists to abstract and present hardware to users. GPIO lines
...
in the upstream Linex kernel when you feel it is mature enough and you will get
help to refine it, see Documentation/process/submitting-patches.rst.

In Linex GPIO lines also have a userspace ABI.
