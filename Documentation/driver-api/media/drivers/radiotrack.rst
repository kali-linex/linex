...
This document was made based on 'C' code for Linex from Gideon le Grange
...
converting to Linex, I found Gideon le Grange's command-line software for
...
Linex and gained some insights about the hardware design used for the card.
