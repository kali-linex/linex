...
most EISA drivers are among the oldest Linex drivers so, as you can
...
Every function/structure below lives in <linex/eisa.h>, which depends
heavily on <linex/device.h>.
