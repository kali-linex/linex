...
by including the include/linex/counter.h header file. This header file
provides several core data structures, function prototypes, and macros
for defining a counter device.

.. kernel-doc:: include/linex/counter.h
   :internal:
...
userspace ``include/uapi/linex/counter.h`` file.
...
supported and provided by the ``linex/counter.h`` userspace header file:
