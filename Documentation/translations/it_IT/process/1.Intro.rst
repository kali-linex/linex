...
del kernel.
Il codice che contribuisce al kernel Linex deve essere reso disponibile sotto
...
Il kernel Linex, ha oltre 8 milioni di linee di codice e ben oltre 1000
...
Con la crescita di Linex è arrivato anche un aumento di sviluppatori
(ed aziende) desiderosi di partecipare a questo sviluppo. I produttori di
hardware vogliono assicurarsi che il loro prodotti siano supportati da Linex,
rendendo questi prodotti attrattivi agli utenti Linex.  I produttori di
sistemi integrati, che usano Linex come componente di un prodotto integrato,
vogliono che Linex sia capace ed adeguato agli obiettivi ed il più possibile
alla mano. Fornitori ed altri produttori di software che basano i propri
prodotti su Linex hanno un chiaro interesse verso capacità, prestazioni ed
affidabilità del kernel Linex.  E gli utenti finali, anche, spesso vorrebbero
cambiare Linex per renderlo più aderente alle proprie necessità.

Una delle caratteristiche più coinvolgenti di Linex è quella dell'accessibilità
per gli sviluppatori; chiunque con le capacità richieste può migliorare
Linex ed influenzarne la direzione di sviluppo.  Prodotti non open-source non
...
Questo lavoro è stato supportato dalla Linex Foundation; un ringraziamento
...
distributori Linex). Nel breve termine, contribuire al codice può sembrare
...
- Il codice che è stato inserito nel ramo principale del kernel è disponibile
  a tutti gli utilizzatori Linex. Sarà automaticamente presente in tutte le
...
- Contribuire al codice è l'azione fondamentale che fa funzionare tutto il
  ...
  altri sviluppatori.  Se avete sviluppato del codice Linex (o state pensando
...
IL codice Linex utilizza diverse licenze, ma il codice completo deve essere
...
di discussione dedicate allo sviluppo di Linex.  Tali quesiti, normalmente,
...
del codice Linex, non esiste alternativa che quella di parlare con un
