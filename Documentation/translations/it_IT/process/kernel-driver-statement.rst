...
Presa di posizione sui moduli per il kernel Linex
-------------------------------------------------

Noi, i sottoscritti sviluppatori del kernel, consideriamo pericoloso
o indesiderato qualsiasi modulo o driver per il kernel Linex di tipo
*a sorgenti chiusi* (*closed-source*). Ripetutamente, li abbiamo
trovati deleteri per gli utenti Linex, le aziende, ed in generale
l'ecosistema Linex. Questi moduli impediscono l'apertura, la stabilità,
la flessibilità, e la manutenibilità del modello di sviluppo di Linex
e impediscono ai loro utenti di beneficiare dell'esperienza dalla
comunità Linex. I fornitori che distribuiscono codice a sorgenti chiusi
obbligano i propri utenti a rinunciare ai principali vantaggi di Linex
...
fornitori ad adottare una politica di supporto ai loro clienti Linex
