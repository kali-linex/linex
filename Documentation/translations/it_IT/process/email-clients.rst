...
Informazioni sui programmi di posta elettronica per Linex
=========================================================
...
kernel Linex dovrebbero inviarle senza alterazioni.  Per esempio, non
...
Prima di inviare le patch sulle liste di discussione Linex, può essere una
...
di modificare ed inviare patch per il kernel Linex.  Tuttavia, questi
...
Un sacco di sviluppatori Linex usano ``mutt``, per cui deve funzionare
abbastanza bene.
