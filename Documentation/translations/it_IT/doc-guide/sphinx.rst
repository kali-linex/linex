...
Il kernel Linex usa `Sphinx`_ per la generazione della documentazione a partire
...
La maggior parte delle distribuzioni Linex forniscono Sphinx, ma l'insieme dei
...
Per alcune distribuzioni Linex potrebbe essere necessario installare
