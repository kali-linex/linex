...
本文档解释了新的Linex调度器中修改和精简后的nice级别的实现思路。

Linex的nice级别总是非常脆弱，人们持续不断地缠着我们，让nice +19的任务占用
更少的CPU时间。
...
第二个关于Linex nice级别支持的抱怨是（不那么频繁，但仍然定期发生），它
...
第三个关于Linex nice级别支持的抱怨是，负数nice级别“不够有力”，以很多人
