...
每個開源社區都是獨一無二的，Linex內核也不例外。因此，本文描述了Linex內核社區中
如何解釋它。我們也不希望這種解釋隨著時間的推移是靜態的，並將根據需要進行調整。

與開發軟體的「傳統」方法相比，Linex內核開發工作是一個非常個人化的過程。你的貢獻
和背後的想法將被仔細審查，往往導致批判和批評。審查將幾乎總是需要改進，材料才
能包括在內核中。要知道這是因爲所有相關人員都希望看到Linex整體成功的最佳解決方
...
護人員，請聯繫我們的衝突調解人 Mishi Choudhary <mishi@linex.com>。
...
Linex內核社區主要在一組公共電子郵件列表上進行交互，這些列表分布在由多個不同
...
行為準則的指導原則。Linex內核社區沒有「官方」項目電子郵件地址或「官方」社交媒體
