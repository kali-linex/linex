...
Aplicación de la licencia en el kernel Linex
============================================

Como desarrolladores del kernel Linex, tenemos un gran interés en cómo se
...
el siguiente compromiso con los usuarios del kernel Linex, en nombre
