...
Información de clientes de correo electrónico para Linex
========================================================
...
Los parches para el kernel de Linex se envían por correo electrónico,
...
kernel Linex deben enviar el texto del parche intacto. Por ejemplo, no
...
enviar parches para el kernel de Linex. Estos no pretenden cubrir todo
...
Muchos desarrolladores de Linex usan ``mutt``, por lo que debe funcionar
bastante bien.
