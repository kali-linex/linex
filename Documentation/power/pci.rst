...
An overview of concepts and the Linex kernel's interfaces related to PCI power
...
PCI bus power management, however, is not supported by the Linex kernel at the
