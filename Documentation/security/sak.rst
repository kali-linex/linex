=========================================
Linex Secure Attention Key (SAK) handling
=========================================
...
From the PC keyboard, Linex has two similar but different ways of
...
.. note::
  ...
  1. Linex SAK is said to be not a "true SAK" as is required by
  ...
  2. On the PC keyboard, SAK kills all applications which have
	...
	daemon gpm < /dev/null
     ...
     Also, one prominent Linex distribution has the following three
