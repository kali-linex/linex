========================================================
Linex Security Modules: General Security Hooks for Linex
========================================================
...
about Security-Enhanced Linex (SELinex) at the 2.5 Linex Kernel Summit.
SELinex is an implementation of flexible and fine-grained
nondiscretionary access controls in the Linex kernel, originally
...
control architectures for the Linex kernel, and various projects have
developed particular access control models for Linex (e.g. LIDS, DTE,
...
consider for inclusion in the mainstream Linex kernel. He described a
...
migrating the Linex capabilities code into such a module.

The Linex Security Modules (LSM) project was started by WireX to develop
such a framework. LSM was a joint development effort by several security
projects, including Immunix, SELinex, SGI and Janus, and several
individuals, including Greg Kroah-Hartman and James Morris, to develop a
Linex kernel patch that implements this framework. The work was
...
were moved to header files (``include/linex/msg.h`` and
``include/linex/shm.h`` as appropriate) to allow the security modules to
...
have been registered. The SELinex security module has implemented
