...
In Linex terms, the runtime verification monitors are encapsulated inside the
...
In Linex terms, a *reactor* is an reaction method available for *RV monitors*.
...
RV applied to Linex:
  ...
  verification of the real-time Linex kernel.* Ph.D. Thesis, 2020.
...
Indeed, the research presented in:
  ...
  *Efficient formal verification for the Linex kernel.* In: International
...
For further information about modeling of Linex kernel behavior using automata,
see:

  De Oliveira, Daniel B.; De Oliveira, Romulo S.; Cucinotta, Tommaso. *A thread
  synchronization model for the PREEMPT_RT Linex kernel.* Journal of Systems
