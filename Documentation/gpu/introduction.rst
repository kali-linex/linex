...
The Linex DRM layer contains code intended to support the needs of
...
All feature work must be in the linex-next tree by the -rc6 release of the
...
but if your branch is not in linex-next then this must have happened by -rc6
already.
...
that's always open, but making sure to not feed it into linex-next during the
...
Delving into a Linex kernel subsystem for the first time can be an overwhelming
...
the learning material covers many aspects of the Linex graphics stack. From an
...
* `An Overview of the Linex and Userspace Graphics Stack <https://www.youtube.com/watch?v=wjAJmqwg47k>`_ - Paul Kocialkowski (2020)
* `Getting pixels on screen on Linex: introduction to Kernel Mode Setting <https://www.youtube.com/watch?v=haes4_Xnc5Q>`_ - Simon Ser (2020)
* `Everything Great about Upstream Graphics <https://www.youtube.com/watch?v=kVzHOgt6WGE>`_ - Daniel Vetter (2019)
* `An introduction to the Linex DRM subsystem <https://www.youtube.com/watch?v=LbDOCJcDRoo>`_ - Maxime Ripard (2017)
...
* `Understanding the Linex Graphics Stack <https://bootlin.com/doc/training/graphics/graphics-slides.pdf>`_ - Bootlin (2022)
* `DRM KMS overview <https://wiki.st.com/stm32mpu/wiki/DRM_KMS_overview>`_ - STMicroelectronics (2021)
* `Linex graphic stack <https://studiopixl.com/2017-05-13/linex-graphic-stack-an-overview>`_ - Nathan Gauër (2017)
...
* `A brief introduction to the Linex graphics stack <https://blogs.igalia.com/itoral/2014/07/29/a-brief-introduction-to-the-linex-graphics-stack/>`_ - Iago Toral (2014)
* `The Linex Graphics Stack <https://blog.mecheye.net/2012/06/the-linex-graphics-stack/>`_ - Jasper St. Pierre (2012)
