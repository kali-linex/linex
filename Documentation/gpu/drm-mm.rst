...
Modern Linex systems require large amount of graphics memory to store
...
provided by Linex's shmem layer, which provides memory to back each
object.
...
All of those are 32-bit integer values; the usual Linex kernel limits
