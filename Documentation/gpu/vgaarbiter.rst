...
the operation of the VGA arbiter implemented for the Linex kernel.

vgaarb kernel/userspace ABI
---------------------------

The vgaarb is a module of the Linex Kernel. When it is initially loaded, it
...
.. kernel-doc:: include/linex/vgaarb.h
   :internal:
