...
- The PC is given full control over the radio
  ...
  (however, this feature is not supported yet by the Linex 6pack driver).
...
protocol to program the Linex driver.
...
- In the linex kernel configuration program, select the code maturity level
...
transmitted. Under Linex, the 6pack layer is beyond the AX.25 layer,
