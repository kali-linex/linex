...
Linex kernel provides TLS connection offload infrastructure. Once a TCP
 ...
 * Full TCP NIC offload mode (``TLS_HW_RECORD``) - mode of operation where
   ...
   making use of the Linex networking stack for example any firewalling
...
The Linex networking stack does not provide a way of reporting per-packet
