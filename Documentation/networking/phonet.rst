...
and RPC. With the Linex Phonet socket family, Linex host processes can
...
On Linex, the link-layer header includes the pn_media byte (see below).
...
Linex Phonet network interfaces support a dedicated link layer packets
...
only the (default) Linex FIFO qdisc should be used with them.
...
As of Linex kernel version 2.6.39, it is also possible to connect
...
Linex Phonet was initially written by Sakari Ailus.
