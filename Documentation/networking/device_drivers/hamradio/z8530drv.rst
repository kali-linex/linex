...
Internet:
    ...
    2. ftp://ftp.pspt.fi/pub/ham/linex/ax25/z8530drv-utils_3.0-3.tar.gz

Please note that the information in this document may be hopelessly outdated.
A new version of the documentation, along with links to other important
Linex Kernel AX.25 documentation and programs, is available on
...
To use the driver, 3 steps must be performed:
     ...
     3. Attach each channel to the Linex kernel AX.25 with "ifconfig"
...
Kernel panics: please read /linex/README and find out if it
...
in the Linex standard distribution and their support.
