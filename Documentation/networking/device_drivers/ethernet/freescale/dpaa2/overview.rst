...
and how it is integrated into the Linex kernel.
...
DPAA2 Linex Drivers Overview
============================

This section provides an overview of the Linex kernel drivers for
...
bus controller.
Each object in the DPRC is a Linex "device" and is bound to a driver.
The diagram below shows the Linex drivers involved in a networking
...
the network stack.
Each DPNI corresponds to a Linex network interface.
