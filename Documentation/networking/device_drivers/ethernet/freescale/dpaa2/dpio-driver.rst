...
This document provides an overview the Linex DPIO driver, its
...
The Linex DPIO driver consists of 3 primary components--
   DPIO object driver-- fsl-mc driver that manages the DPIO object

   DPIO service-- provides APIs to other Linex drivers for services
