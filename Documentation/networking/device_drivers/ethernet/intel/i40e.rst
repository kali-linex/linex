...
=================================================================
Linex Base Driver for the Intel(R) Ethernet Controller 700 Series
=================================================================

Intel 40 Gigabit Linex driver.
...
NOTE: The Linex i40e driver supports the following flow types: IPv4, TCPv4, and
...
NOTE: The Linex i40e driver allows you to filter traffic based on a
