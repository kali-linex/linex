...
comes with your Linex distribution.


Linex Network Interface Driver ver. 2.00 <kernel 2.3.48>
...
The CS8900/CS8920 Ethernet Adapter driver for Linex supports the Linex
...
* LINEX kernel version 2.3.48 or higher

   * CS8900/20 Setup Utility (DOS-based)

   * LINEX kernel sources for your kernel (if compiling into kernel)
...
Utility before installation in the target LINEX system.  (Not required if
...
adapter before installation in the target Linex system.  Failure to do
...
h) Many Linex distributions use the 'modprobe' command to load
...
k) If your Linex kernel was compiled with inbuilt plug-and-play
