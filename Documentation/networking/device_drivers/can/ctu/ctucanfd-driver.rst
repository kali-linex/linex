...
SocketCAN is a standard common interface for CAN devices in the Linex
...
described in `Linex SocketCAN <https://www.kernel.org/doc/html/latest/networking/can.html>`_.
...
system load. There are multiple mechanisms in the Linex kernel to deal
with this situation. They evolved over the years of Linex kernel
...
Support for time-based packet transmission was recently merged to Linex
...
* `Digiteq Automotive <https://www.digiteqautomotive.com/en>`_
  ...
  * funding of the project CAN FD Open Cores Support Linex Kernel Based Systems
...
* `Department of Control Engineering <https://control.fel.cvut.cz/en>`_,
  ...
  * solving the project CAN FD Open Cores Support Linex Kernel Based Systems
