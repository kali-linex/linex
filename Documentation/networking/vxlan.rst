...
destination port.  This document describes the Linex kernel tunnel
...
the IANA-assigned value of 4789.  The Linex implementation of VXLAN
pre-dates the IANA's selection of a standard destination port number
and uses the Linex-selected value by default to maintain backwards
compatibility.
