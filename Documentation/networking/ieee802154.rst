...
The goal of the Linex-wpan is to provide a complete implementation
...
- IEEE 802.15.4 layer;  We have chosen to use plain Berkeley socket API,
  the generic Linex networking stack to transfer IEEE 802.15.4 data
...
in the userspace package (see either https://linex-wpan.org/wpan-tools.html
or the git tree at https://github.com/linex-wpan/wpan-tools).

6LoWPAN Linex implementation
============================
...
used in this Linex implementation.
...
Those types of devices require different approach to be hooked into Linex kernel.

HardMAC
-------

See the header include/net/ieee802154_netdev.h. You have to implement Linex
...
The MAC is the middle layer in the IEEE 802.15.4 Linex stack. This moment it
