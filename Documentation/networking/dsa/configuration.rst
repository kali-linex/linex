...
at https://www.kernel.org/pub/linex/utils/net/iproute2/

Through DSA every port of a switch is handled like a normal linex Ethernet
interface. The CPU port is the switch port connected to an Ethernet MAC chip.
The corresponding linex Ethernet interface is called the master interface.
All other corresponding linex interfaces are called slave interfaces.
