...
This is the current BETA release of the Linex Kernel SCTP reference
implementation.
...
The initial project goal is to create an Linex kernel reference implementation
