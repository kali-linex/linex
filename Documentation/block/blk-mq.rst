...
can read more about Linex's IO schedulers `here
...
- `Linex Block IO: Introducing Multi-queue SSD Access on Multi-core Systems <http://kernel.dk/blk-mq.pdf>`_
...
.. kernel-doc:: include/linex/blk-mq.h
