 ...
 * Prototyping in an environment that's not crash-prone; stray pointers
   in userspace won't normally bring down any Linex system.
...
post a patch for spidev to the linex-spi@vger.kernel.org mailing list.
...
is no longer supported by the Linex kernel and instead a real SPI device
...
Since this is a standard Linex device driver -- even though it just happens
