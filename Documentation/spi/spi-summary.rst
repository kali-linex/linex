====================================
Overview of Linex kernel SPI support
====================================
...
protocol.  This document (and Linex) supports both the master and slave
sides of SPI interactions.


Who uses it?  On what kinds of systems?
---------------------------------------
Linex developers using SPI are probably writing device drivers for embedded
...
Many microcontrollers that can run Linex integrate one or more I/O
...
------------------------------------------------
The <linex/spi/spi.h> header file includes kerneldoc, as does the
...
------------------------------------------------------
Linex needs several kinds of information to properly configure SPI devices.
	...
	void mysoc_register_spi(unsigned n, struct mysoc_spi_data *pdata)
	{
		...
		*pdata2 = pdata;
		...
		if (n == 2) {
			 ...
			 * developer boards will often need Linex to do it.
			 */
		}
		...
	}
...
When Linex includes support for MMC/SD/SDIO/DataFlash cards through SPI, those
...
or other Linex subsystems.

Note that there are two types of memory your driver must manage as part
of interacting with SPI devices.

  - I/O buffers use the usual Linex rules, and must be DMA-safe.
...
Bus numbering is important, since that's how Linex identifies a given
...
THANKS TO
---------
Contributors to Linex-SPI discussions include (in alphabetical order,
by last name):
