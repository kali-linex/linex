...
- Modified by Christoph Lameter <cl@linex.com>
...
leverages existing CPU and Memory Placement facilities in the Linex
...
Cpusets provide a Linex kernel mechanism to constrain which CPUs and
Memory Nodes are used by a process or set of processes.

The Linex kernel already has a pair of mechanisms to specify on which
...
exclusive cpuset.  Also, the use of a Linex virtual file system (vfs)
