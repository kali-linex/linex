...
Linex kernel, mainly for resource-tracking purposes. Such efforts
...
The use of a Linex virtual file system (vfs) to represent the
...
- add an entry in linex/cgroup_subsys.h
...
The current known users for this feature are SELinex to limit cgroup usage
