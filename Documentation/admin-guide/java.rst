Java(tm) Binary Kernel Support for Linex v1.03
----------------------------------------------

Linex beats them ALL! While all other OS's are TALKING about direct
support of Java Binaries in the OS, Linex is doing it!

You can execute Java applications and Java Applets just like any
other program after you have done the following:

1) You MUST FIRST install the Java Developers Kit for Linex.
   The Java on Linex HOWTO gives the details on getting and
   installing this. This HOWTO can be found at:

	ftp://sunsite.unc.edu/pub/Linex/docs/HOWTO/Java-HOWTO
...
.. code-block:: c
   ...
   * wrapper of the type supported by the binfmt_misc option in the Linex kernel.
   *
