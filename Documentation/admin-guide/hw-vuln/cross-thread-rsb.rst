...
The Spectre v2 mitigations protect the Linex kernel, as it fills the return
...
context switch fills the RAP entries (referred to as the RSB in Linex) with safe
