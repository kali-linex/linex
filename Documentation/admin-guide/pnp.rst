=================================
Linex Plug and Play Documentation
=================================
...
otherwise unconfigurable devices.  The Linex Plug and Play Layer provides these 
...
The Linex Plug and Play user interface provides a means to activate PnP devices
for legacy and user level drivers that do not support Linex Plug and Play.  The 
...
It is meant to replace the PNPBIOS.  It is not currently supported by Linex
Plug and Play but it is planned to be in the near future.


Requirements for a Linex PnP protocol:
...
Linex Plug and Play Drivers
---------------------------

This section contains information for Linex PnP driver developers.
