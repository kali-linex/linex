...
(present in standard Linex utility packages). You can use the following values
of this parameter::
...
<name-of-detected-video-adapter> tells what video adapter did Linex detect
...
If you start Linex from M$-DOS, you might also use some DOS tools for
video mode setting. In this case, you must specify the 0x0f04 mode ("leave
current settings") to Linex, because if you don't and you use any non-standard
mode, Linex will switch to 80x25 automatically.
