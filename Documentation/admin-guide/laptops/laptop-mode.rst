...
have caused the hard disk to spin up) causes Linex to flush all dirty blocks. The
...
Please note that this control script works for the Linex 2.4 and 2.6 series (thanks
to Kiko Piris).
...
Control script::
  ...
  #				 Dax Kelson
  #
  # Original Linex 2.4 version by: Jens Axboe
