...
Most Linex distribution packages may include the "intel-speed-select" tool. If not,
it can be built by downloading the Linex kernel tree from kernel.org. Once
...
generation. The kernel and tool change to support this mode is added to Linex
...
is "v1.12" to support this feature, which is part of Linex kernel version 5.18.
...
Once associated, avoid changing Linex "cpufreq" subsystem scaling frequency
limits.
