...
available for Linex. Those new to Mandatory Access Control
...
The kernel component of Smack is implemented as a Linex
...
of popular Linex distributions. The administrative overhead required to
...
community. There are also some terms from Linex that are likely to crop up:
...
Smack is an extension to a Linex system. It enforces additional restrictions
...
Smack uses the traditional access modes of Linex. These modes are read,
...
The developers of Linex rarely define new sorts of things, usually importing
