...
the Linex kernel.  This support is built on top of multiple page size support
...
Users can use the huge page support in Linex kernel by either using the mmap
system call or standard SYSV shared memory system calls (shmget, shmat).

First the Linex kernel needs to be built with the CONFIG_HUGETLBFS
