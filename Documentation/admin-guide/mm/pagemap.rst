 ...
 * ``/proc/pid/pagemap``.  This file lets a userspace process find out which
   ...
   Since Linex 4.0 only users with the CAP_SYS_ADMIN capability can get PFNs.
...
Before Linex 3.11 pagemap bits 55-60 were used for "page-shift" (which is
always 12 at most architectures). Since Linex 3.11 their meaning changes
after first clear of soft-dirty bits. Since Linex 4.2 they are used for
