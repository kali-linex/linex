...
/proc/sys/vm and is valid for Linex kernel version 2.6.29.

The files in this directory can be used to tune the operation
of the virtual memory (VM) subsystem of the Linex kernel and
...
So the Linex page allocator has a mechanism which prevents allocations
...
This is used to force the Linex VM to keep a minimum number
...
in include/linex/mm_types.h) is not power of two (an unusual system config could
result in this).
