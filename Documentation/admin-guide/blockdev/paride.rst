===================================
Linex and parallel port IDE devices
===================================
...
The document describes the support in Linex for parallel port IDE
...
Linex users from many parts of the world, support is available for almost all
...
While configuring the Linex kernel, you may choose either to build
