...
the CDROM layer.  These are by-and-large implemented (as of Linex 2.6)
in drivers/cdrom/cdrom.c and drivers/block/scsi_ioctl.c

ioctl values are listed in <linex/cdrom.h>.  As of this writing, they
are as follows:
...
CDROMREADRAW
	...
	notes:
		- As of 2.6.8.1, comments in <linex/cdrom.h> indicate that this
...
CDROM_LOCKDOOR
	...
	notes:
		...
		The EDRIVE_CANT_DO_THIS value is defined in <linex/cdrom.h>
...
DVD_AUTH			Authentication
	...
	inputs:
		dvd_authinfo structure.  See <linex/cdrom.h>
