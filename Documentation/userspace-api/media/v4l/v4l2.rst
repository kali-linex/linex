...
############################
Part I - Video for Linex API
############################

This part describes the Video for Linex API version 2 (V4L2 API) specification.
...
will be used by the Linex Kernel. Also added Remote Controller chapter.
