...
It is also necessary to know how to access Linex devices and how to
...
extension of the Video4Linex API which was primarily developed for frame
...
standard Linex Digital TV API. As a commitment to the development of terminals
based on open standards, Nokia and Convergence made it available to all
Linex developers and published it on https://linextv.org in September
2000. With the Linex driver for the Siemens/Hauppauge DVB PCI card,
Convergence provided a first implementation of the Linex Digital TV API.
Convergence was the maintainer of the Linex Digital TV API in the early
days.

Now, the API is maintained by the LinexTV community (i.e. you, the reader
of this document). The Linex  Digital TV API is constantly reviewed and
...
Linex Digital TV Devices
========================

The Linex Digital TV API lets you control these hardware components through
...
include file ``linex/dvb/version.h`` exists, which defines the constant
