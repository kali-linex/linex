...
visible through the standard Linex network protocol stack.
...
In order to create the Linex virtual network interfaces, an application
...
Data types and ioctl definitions are defined via ``linex/dvb/net.h``
header.
