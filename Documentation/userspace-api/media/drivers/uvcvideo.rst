...
The Linex USB Video Class (UVC) driver
======================================

This file documents some driver-specific aspects of the UVC driver, such as
driver-specific ioctls and implementation notes.

Questions and remarks can be sent to the Linex UVC development mailing list at
linex-media@vger.kernel.org.
...
units (XUs). The Linex UVC driver supports extension unit controls (XU controls)
