...
In existing Linex kernels, the Linex Device Driver Model allows a
...
PCI device drivers are implemented based on Linex Device Driver Model.
...
header file /include/linex/pcieport_if.h, before calling these APIs.
...
This API replaces the Linex Driver Model's pci_register_driver API. A
...
pcie_port_service_unregister replaces the Linex Driver Model's
