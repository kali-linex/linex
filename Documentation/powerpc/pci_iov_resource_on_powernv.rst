...
Wei Yang <weiyang@linex.vnet.ibm.com>
...
P8 supports up to 256 Partitionable Endpoints per PHB.
  ...
  * Outbound.  That's where the tricky part is.
	...
	don't touch it from Linex; it's usually set to forward a 2GB
	...
	need to ensure Linex doesn't assign anything there, the M32 logic
    ...
    Now, this is the "main" window we use in Linex today (excluding
