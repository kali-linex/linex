...
characteristic is presented in terms of NUMA node distance within the Linex kernel.
...
Linex kernel uses the domainID at the primary domainID index as the NUMA node id.
Linex kernel computes NUMA distance between two domains by recursively comparing
