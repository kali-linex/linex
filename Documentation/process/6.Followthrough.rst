...
mind:
 ...
 - If you have explained your patch well, reviewers will understand its
   ...
   to substantial rewrites - come from the understanding that Linex will
...
default.  Subsystem trees typically feed linex-next as well, making their
...
blessings: before the advent of the linex-next tree, these conflicts often
...
eventually flow around you and get into the mainline anyway.  In the Linex
