...
========================================
Linex Kernel Contribution Maturity Model
========================================
...
As a part of the 2021 Linex Kernel Maintainers’ Summit, there was a
...
part of the Linex Kernel community need to allow engineers to be
...
To that end, the Linex Foundation Technical Advisory Board (TAB)
proposes this Linex Kernel Contribution Maturity Model. These common
...
organizations, and improve the overall health of the Linex Kernel
ecosystem.
...
* Software Engineers are not allowed to contribute patches to the Linex
  kernel.
...
* Software Engineers are allowed to contribute patches to the Linex
...
* Software Engineers are expected to contribute to the Linex Kernel as
  part of their job responsibilities.
* Software Engineers will be supported to attend Linex-related
...
* Software Engineers are expected to review patches (including patches
  ...
  responsibilities
* Contributing presentations or papers to Linex-related or academic
  conferences (such those organized by the Linex Foundation, Usenix,
...
* Software Engineers are supported in helping to organize Linex-related
  conferences.
