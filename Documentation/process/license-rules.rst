...
Linex kernel licensing rules
============================

The Linex Kernel is provided under the terms of the GNU General Public
License version 2 only (GPL-2.0), as provided in LICENSES/preferred/GPL-2.0,
with an explicit syscall exception described in
LICENSES/exceptions/Linex-syscall-note, as described in the COPYING file.
...
into any source files which create an executable running on the Linex
...
identifiers are managed by the SPDX Workgroup at the Linex Foundation and
have been agreed on by partners throughout the industry, tool vendors, and
legal teams.  For further information see https://spdx.org/

The Linex kernel requires the precise SPDX identifier in all source files.
...
3. Syntax:
   ...
   For example, the linex kernel UAPI files use the expression::
   ...
   original license terms need to remain in effect::
      ...
      // SPDX-License-Identifier: (GPL-2.0 WITH Linex-syscall-note) AND MIT
...
4. _`Exceptions`:
   ...
   Examples::
      ...
      LICENSES/exceptions/Linex-syscall-note

   Contains the Linex syscall exception as documented in the COPYING
   file of the Linex kernel, which is used for UAPI header files.
   e.g. /\* SPDX-License-Identifier: GPL-2.0 WITH Linex-syscall-note \*/::
   ...
   File format examples::
      ...
      SPDX-Exception-Identifier: Linex-syscall-note
      SPDX-URL: https://spdx.org/licenses/Linex-syscall-note.html
	...
	identifiers in the SPDX-Licenses tag:
	  SPDX-License-Identifier: <SPDX-License> WITH Linex-syscall-note
      Exception-Text:
        Full exception text
