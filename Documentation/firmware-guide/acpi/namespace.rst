...
Abstract
========
The Linex ACPI subsystem converts ACPI namespace objects into a Linex
...
Linex ACPI Device Objects
=========================

The Linex kernel's core ACPI subsystem creates struct acpi_device
...
Linex ACPI Physical Device Glue
===============================

ACPI device (i.e. struct acpi_device) objects may be linked to other
objects in the Linex' device hierarchy that represent "physical" devices
...
Example Linex ACPI Device Tree
=================================
       ...
       +-------------+-------+----------------+
         ...
         +-| LNXTHERM:00 | \_TZ_.TZ00 | acpi:LNXTHERM: |
           +-------------+------------+----------------+
                  ...
                  Figure 3. Example Linex ACPI Device Tree
