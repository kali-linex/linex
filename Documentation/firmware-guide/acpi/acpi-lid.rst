...
exceptions of the Linex ACPI lid device driver.
...
events and the unreliable initial state notification, Linex users can use
...
and the unreliable initial state notification, Linex users should always
