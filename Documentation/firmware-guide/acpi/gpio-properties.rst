...
Linex tries to use common sense here and derives the state from the bias
...
polarity and Linex will configure the pins in this state until a driver
...
mapping, the Linex GPIO framework refuses to return any GPIOs. This is
