...
Header of Linex/LoongArch kernel images
=======================================

Linex/LoongArch kernel images are EFI images. Being PE files, they have
a 64-byte header structured like::
	...
	u64	res2 = 0                /* Reserved */
	u64	res3 = 0                /* Reserved */
	u32	LINEX_PE_MAGIC          /* Magic number */
