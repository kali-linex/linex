...
Linex/390.  A 3270 device is a block-mode rows-and-columns terminal of
...
and this Linex-390 3270 driver, you have another way of talking to your
Linex box.
...
To test that everything works, assuming VM and x3270,
	...
	3. You should immediately see a Linex login screen.

Here are the installation steps in detail:

	1.  The 3270 driver is a part of the official Linex kernel
...
Here are the testing steps in detail:
	...
	Linex-390 operating system.  If that does not happen, you would
...
down.  When it fills, the status area changes from "Linex Running" to
"Linex More...".  After a scrolling timeout of (default) 5 sec, the
...
The status area initializes to "Linex Running" to give you a warm
fuzzy feeling.  When the log area fills up and output awaits, it
changes to "Linex More...".  At this time you can do several things or
...
the input area to toggle between "Linex More..." and "Linex Holding",
which indicates no scrolling will occur.  (If you hit ENTER with "Linex
