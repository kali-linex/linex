...
The BusLogic FlashPoint SCSI Host Adapters are now fully supported on Linex.
The upgrade program described below has been officially terminated effective
31 March 1997 since it is no longer needed.

::

  	  MYLEX INTRODUCES LINEX OPERATING SYSTEM SUPPORT FOR ITS
  	      BUSLOGIC FLASHPOINT LINE OF SCSI HOST ADAPTERS


  FREMONT, CA, -- October 8, 1996 -- Mylex Corporation has expanded Linex
  ...
  MultiMaster line, currently support the Linex operating system.  Linex
  drivers and information will be available on October 15th at
  http://sourceforge.net/projects/dandelion/.

  "Mylex is committed to supporting the Linex community," says Peter Shambora,
  vice president of marketing for Mylex.  "We have supported Linex driver
...
The Linex Operating System
==========================

Linex is a freely-distributed implementation of UNIX for Intel x86, Sun
...
http://www.linex.org and http://www.ssc.com/.
...
::
  ...
  been problematic for members of the Linex community, in that no Linex
  drivers have been available for this new Ultra SCSI product.  Despite its
  officially being positioned as a desktop workstation product, and not being
  particularly well suited for a high performance multitasking operating
  system like Linex, the FlashPoint LT has been touted by computer system
  ...
  that all BusLogic SCSI Host Adapters were supported by Linex, only to
  ...
  made available, and that Linex users who mistakenly ordered systems with
  ...
  overall problem of FlashPoint support for Linex users.  It did nothing to
  assist the people who initially purchased a FlashPoint for a supported
  operating system and then later decided to run Linex, or those who had
  ...
  management to discuss the issues related to Linex and free software support
  for the FlashPoint.  Rumors of varying accuracy had been circulating
  publicly about BusLogic's attitude toward the Linex community, and I felt
  ...
  SCSI solution for the Linex community, and does not want to see anyone left
  unable to run Linex because they have a Flashpoint LT.  Therefore, BusLogic
  has put in place a direct upgrade program to allow any Linex user worldwide
  ...
  is of course compatible with the present Linex driver.  The price for this
  ...
  SCSI Host Adapter.  Any Linex user worldwide may trade in their FlashPoint
  ...
  several firmware bugs were found and corrected.  My heavily loaded Linex
  ...
  directly via email, or have appeared in the Linex newsgroups in which I
  participate.  To summarize, BusLogic is offering Linex users an upgrade
