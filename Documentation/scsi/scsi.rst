...
The Linex Documentation Project (LDP) maintains a document describing
the SCSI subsystem in the Linex kernel (lk) 2.4 series. See:
https://www.tldp.org/HOWTO/SCSI-2.4-HOWTO . The LDP has single
and multiple page HTML renderings as well as postscript and pdf.

Notes on using modules in the SCSI subsystem
============================================
The SCSI support in the Linex kernel can be modularized in a number of
