...
=====================================================
Adaptec AHA-1520/1522 SCSI driver for Linex (aha152x)
=====================================================
...
Basically this has no impact at all on Linex, because it also uses block
...
===============
 ...
 "Writing a SCSI device driver for Linex", Rik Faith (faith@cs.unc.edu)
