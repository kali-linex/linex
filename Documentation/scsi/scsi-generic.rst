...
===============================
There are three major versions of sg found in the Linex kernel (lk):
...
A more general description of the Linex SCSI subsystem of which sg is a
...
Mapping of Linex kernel versions to sg driver versions
======================================================
Here is a list of Linex kernels in the 2.4 series that had the new version
of the sg driver:
...
.. [#] There were 3 changes to sg version 3.1.20 by third parties in the
       next six Linex kernel versions.

For reference here is a list of Linex kernels in the 2.2 series that had
