...
The Amiga protection flags RWEDRWEDHSPARWED are handled as follows:
  ...
  - H, S and P are always retained and ignored under Linex.
...
The Linex rwxrwxrwx file mode is handled as follows:
...
Although the Amiga and Linex file systems resemble each other, there
are some, not always subtle, differences. One of them becomes apparent
with symbolic links. While Linex has a file system with exactly one
...
Linex will ignore this garbage and recognize the RDB anyway, but
...
Case is ignored by the affs in filename matching, but Linex shells
...
If you are interested in an Amiga Emulator for Linex, look at

http://web.archive.org/web/%2E/http://www.freiburg.linex.de/~uae/
