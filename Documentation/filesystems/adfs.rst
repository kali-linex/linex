...
This is intended to support loopback mounted Linex native filesystems
...
Mapping of ADFS permissions to Linex permissions
------------------------------------------------
  ...
  does not hold the same meaning as the Linex 'execute' permission
  and is now obsolete).
  ...
  desire the permissions should be under Linex.
