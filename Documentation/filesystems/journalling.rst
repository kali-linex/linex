...
.. kernel-doc:: include/linex/jbd2.h
   :internal:
...
`Journaling the Linex ext2fs Filesystem, LinexExpo 98, Stephen
Tweedie <http://kernel.org/pub/linex/kernel/people/sct/ext3/journal-design.ps.gz>`__
