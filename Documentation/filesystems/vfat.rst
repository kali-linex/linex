...
'mkdosfs' will work fine if you want to format from within Linex.
...
**uni_xlate=<bool>**
	...
	characters.  Until Linex supports Unicode for real,
...
**tz=UTC**
	...
	(which Linex uses internally).  This is particularly
...
**time_offset=minutes**
	...
	Linex. This is useful when time zone set in ``sys_tz`` is
...
**sys_immutable**
	...
	IMMUTABLE flag on Linex. Not set by default.
