...
===============
  ...
  systems such as Linex and Windows 95 and NT have virtual filesystem
...
------------
  ...
  .. Note::
     ...
     coda_vtype. Linex does not take note of CFS_NOCACHE.  It should.
...
-------------
  ...
  .. Note::
     ...
     Many kernel FS drivers (Linex, NT and Windows 95) need to acquire
...
------------
  ...
  .. Note:: Linex does not implement this call. It should.
...
===============================
  ...
  internal file handles (called vnodes in BSD, inodes in Linex and
...
-------------
  ...
  .. Note::
     ...
     zapfile routine takes different arguments. Linex does not implement
...
------------------
  ...
  .. Note::
     ...
     NetBSD in particular but also Linex have not implemented the
