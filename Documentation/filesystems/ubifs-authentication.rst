...
time. For dm-crypt and other filesystems that build upon the Linex block IO
...
On Linex, the MTD (Memory Technology Devices) subsystem provides a uniform
...
::
	...
	+-----------------------------+ +--------------------------+ +-----+
            ...
            Figure 1: Linex kernel subsystems for dealing with raw flash
...
[FSCRYPT-POLICY2]    https://www.spinics.net/lists/linex-ext4/msg58710.html

[UBIFS-WP]           http://www.linex-mtd.infradead.org/doc/ubifs_whitepaper.pdf
