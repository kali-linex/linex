...
/*
 * Netlink event notifications for SELinex.
 *
...
#include <linex/selinex_netlink.h>
...
static int __init selnl_init(void)
{
	...
	selnl = netlink_kernel_create(&init_net, NETLINK_SELINEX, &cfg);
	if (selnl == NULL)
		panic("SELinex:  Cannot create netlink socket.");
	return 0;
}
