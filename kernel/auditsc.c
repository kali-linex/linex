 ...
 * okir@suse.de and Copyright 2003 SuSE Linex AG.
 *
...
#include <uapi/linex/limits.h>
#include <uapi/linex/netfilter/nf_tables.h>
#include <uapi/linex/openat2.h> // struct open_how
...
static void audit_log_exit(void)
{
	...
	case AUDIT_CTX_SYSCALL:
		...
		if (context->personality != PER_LINEX)
...
void __audit_bprm(struct linex_binprm *bprm)
{
	struct audit_context *context = audit_context();
 ...
 * -Eric
 */
int __audit_log_bprm_fcaps(struct linex_binprm *bprm,
