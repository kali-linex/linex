 ...
 * Silva. Efficient formal verification for the Linex kernel. In:
 ...
 * and verification of the real-time Linex kernel. PhD Thesis, 2020.
 *
 ...
 *
 * In Linex terms, the runtime verification monitors are encapsulated
