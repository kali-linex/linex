 ...
 *
 *  This program is largely derived from work by the linex-usb group
...
#ifndef __LINEX_USB_SERIAL_BSA_H
#define __LINEX_USB_SERIAL_BSA_H
...
#endif /* __LINEX_USB_SERIAL_BSA_H */
