...
#define DRIVER_DESC		"Linex USB Audio Gadget"
...
/* Thanks to Linex Foundation for donating this product ID. */
#define AUDIO_VENDOR_NUM		0x1d6b	/* Linex Foundation */
#define AUDIO_PRODUCT_NUM		0x0101	/* Linex-USB Audio Gadget */
