 ...
 * Copyright (C) 2007 Ilyes Gouta. Based on the m5603x Linex Driver Project.
 * Copyright (C) 2005 m5603x Linex Driver Project <m5602@x3ng.com.br>
 *
...
/* Driver info */
#define DRIVER_AUTHOR "ALi m5602 Linex Driver Project"
