 ...
 * @ssp: pointer to a struct sifive_serial_port
 *
 * Transfer up to a TX FIFO size's worth of characters from the Linex serial
 ...
 * to by @ssp and pass them up to the Linex serial layer.
 *
