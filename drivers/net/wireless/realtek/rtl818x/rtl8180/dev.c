...
/* Linex device driver for RTL8180 / RTL8185 / RTL8187SE
 *
 ...
 *
 * based also on:
 *  - portions of rtl8187se Linex staging driver, Copyright Realtek corp.
 *    (available in drivers/staging/rtl8187se directory of Linex 3.14)
 *  - other GPL, unpublished (until now), Linex driver code,
