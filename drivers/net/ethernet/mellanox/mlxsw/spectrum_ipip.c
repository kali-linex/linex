				...
				u32 tunnel_index)
{
	...
	/* Linex demuxes tunnels based on packet SIP (which must match tunnel
	 ...
	 * generated for packets that fail this criterion. Linex then handles
					  ...
					  const struct net_device *ol_dev)
{
	...
	/* Tunnels with unset local or remote address are valid in Linex and
