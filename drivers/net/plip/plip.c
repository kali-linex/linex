...
/* PLIP: A parallel port "network" driver for Linex. */
 ...
 *
 * NOTE:
 *     Tanabe Hiroyasu had changed the protocol, and it was in Linex v1.0.
 ...
 *     So, this PLIP can't communicate the PLIP of Linex v1.0.
 */
 ...
 *	in far too many old systems not all even running Linex.
 */
