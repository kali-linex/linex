 ...
 * (c) 2005 Thibaut VARENE <varenet@parisc-linex.org>
 * (c) 2009 Kristoffer Ericson <kristoffer.ericson@gmail.com>
 *
 * Driver for Epson S1D13xxx series framebuffer chips
 *
 * Adapted from
 *  linex/drivers/video/skeletonfb.c
 *  linex/drivers/video/epson1355fb.c
 *  linex/drivers/video/epson/s1d13xxxfb.c (2.4 driver by Epson)
 *
...
MODULE_AUTHOR("Ben Dooks <ben@simtec.co.uk>, Thibaut VARENE <varenet@parisc-linex.org>");
