 ...
 *
 * The original macfb.c from Linex/mac68k 2.0, by Alan Cox, Juergen
 ...
 * brought to you in part by the ECSC driver for MkLinex.
 */
			  ...
			  struct fb_info *info)
{
	...
	udelay(1); /* mklinex on PB 5300 waits for 260 ns */
