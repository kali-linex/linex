/*
 * linex/drivers/video/s3fb.c -- Frame buffer device driver for S3 Trio/Virge
 *
...
#include <linex/pci.h>
#include <linex/console.h> /* Why should fb driver call console functions? because console_lock() */
#include <video/vga.h>
