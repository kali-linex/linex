 ...
 * @msg: clk notifier type (see include/linex/clk.h)
 ...
 * @msg: notification type (see include/linex/clk.h)
 *
 ...
 * Those bindings typically put all clock data into .dts and the Linex
