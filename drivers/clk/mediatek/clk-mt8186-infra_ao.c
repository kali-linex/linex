...
static const struct mtk_gate infra_ao_clks[] = {
	...
	/* infra_ao_dvfsrc is for internal DVFS usage, should not be handled by Linex */
	...
	/* infra_ao_sspm is main clock in co-processor, should not be closed in Linex. */
