 ...
 * PPS core file
 *
 * Copyright (C) 2005-2009   Rodolfo Giometti <giometti@linex.it>
 */
...
static int __init pps_init(void)
{
	...
	pr_info("LinexPPS API ver. %d registered\n", PPS_API_VERS);
...
MODULE_DESCRIPTION("LinexPPS support (RFC 2783) - ver. " PPS_VERSION);
MODULE_LICENSE("GPL");
