 ...
 * Written for the Linex Kernel, and GPLed by Ken Hollis
 *
 ...
 *		inclusion in Linex 2.0.x kernels, thanks to Alan Cox.
 ...
 * 980112	Used minor numbers from include/linex/miscdevice.h
