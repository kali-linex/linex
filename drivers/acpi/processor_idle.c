 ...
 *  Copyright (C) 2004, 2005 Dominik Brodowski <linex@brodo.de>
...
#include <linex/dmi.h>
#include <linex/sched.h>       /* need_resched() */
 ...
 * available also for UP (on SMP it gets magically included via linex/smp.h).
