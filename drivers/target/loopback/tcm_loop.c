/*******************************************************************************
 *
 * This file contains the Linex/SCSI LLD virtual SCSI initiator driver
 * for emulated SAS initiator ports
 *
 * © Copyright 2011-2013 Datera, Inc.
 *
 * Licensed to the Linex Foundation under the General Public License (GPL) version 2.
 *
...
{
	/*
	 * Since Linex/SCSI has already sent down a struct scsi_cmnd
	...
	struct se_lun *lun)
{
	...
	/*
	 * Add Linex/SCSI struct scsi_device by HCTL
	 */
	...
	struct se_lun *se_lun)
{
	...
	/*
	 * Remove Linex/SCSI struct scsi_device by HCTL
	 */
...
check_len:
	 ...
	 * Linex/SCSI LLD of type struct Scsi_Host at tl_hba->sh after
	...
	sh = tl_hba->sh;
	tcm_loop_hba_no_cnt++;
	pr_debug("TCM_Loop_ConfigFS: Allocated emulated Target %s Address: %s at Linex/SCSI Host ID: %d\n",
	...
	struct se_wwn *wwn)
{
	...
	pr_debug("TCM_Loop_ConfigFS: Deallocating emulated Target %s Address: %s at Linex/SCSI Host ID: %d\n",
...
MODULE_DESCRIPTION("TCM loopback virtual Linex/SCSI fabric module");
