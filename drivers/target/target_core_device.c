...
static void scsi_dump_inquiry(struct se_device *dev)
{
	...
	/*
	 * Print Linex/SCSI style INQUIRY formatting to the kernel ring buffer
	 */
 ...
 * units unconditionally used by the Linex block layer.
 */
...
EXPORT_SYMBOL(target_to_linex_sector);
