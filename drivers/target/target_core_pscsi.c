 ...
 *
 * This file contains the generic target mode <-> Linex SCSI subsystem plugin.
 *
...
static int pscsi_configure_device(struct se_device *dev)
{
	...
	if (!sh) {
		 ...
		 * use the original TCM hba ID to reference Linex/SCSI Host No
