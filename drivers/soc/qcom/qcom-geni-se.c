 ...
 * @se:	Pointer to the concerned serial engine.
 *
 * Return: 0 on success, standard Linex error codes on failure/error.
 */
 ...
 *	   standard Linex error codes on failure.
 */
 ...
 *
 * Return: 0 on success, standard Linex error codes on failure.
 */
