 ...
 * (C) 2003 Linex Networx (http://lnxi.com)
 ...
 *
 * Contributors:
 *	Eric Biederman (Linex Networx)
 *	Tom Zimmerman (Linex Networx)
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Linex Networx (http://lnxi.com) Thayne Harbaugh et al");
