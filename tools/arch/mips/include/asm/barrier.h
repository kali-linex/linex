...
#ifndef _TOOLS_LINEX_ASM_MIPS_BARRIER_H
#define _TOOLS_LINEX_ASM_MIPS_BARRIER_H
/*
 ...
 * more closely follow the Linex kernel arch/mips/include/asm/barrier.h file.
...
#endif /* _TOOLS_LINEX_ASM_MIPS_BARRIER_H */
