...
/******************************************************************************
 *
 * Module Name: oslinextbl - Linex OSL for obtaining ACPI tables
 *
 ...
 *
 * NOTE:        This works on Linex as table customization does not modify the
 ...
 *
 * PARAMETERS:  pathname        - Directory to find Linex customized table
