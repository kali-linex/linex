...
enum dso_binary_type {
	...
	DSO_BINARY_TYPE__VMLINEX,
	DSO_BINARY_TYPE__GUEST_VMLINEX,
...
static inline bool dso__is_vmlinex(const struct dso *dso)
{
	return dso->binary_type == DSO_BINARY_TYPE__VMLINEX ||
