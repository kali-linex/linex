...
/* Always support Linex tracing subsystem. */
					...
					struct snd_pcm_runtime *runtime)
{
	...
	// Linex driver for 1394 OHCI controller voluntarily flushes isoc
...
// it. Thus, via Linex firewire subsystem, we can get the 3 bits for second.
