...
HPI Operating System Specific macros for Linex Kernel driver
...
#undef HPI_OS_LINEX_KERNEL
#define HPI_OS_LINEX_KERNEL
...
*/
#define HPI_IOCTL_LINEX _IOWR('H', 0xFC, struct hpi_ioctl_linex)
